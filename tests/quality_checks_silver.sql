...
===============================================================================
Propósito do Script:
    Este script realiza várias verificações de qualidade para consistência, 
    precisão e padronização dos dados na camada 'silver'. Inclui verificações para:
    - Chaves primárias nulas ou duplicadas.
    - Espaços indesejados em campos de texto (string).
...
-- ====================================================================
-- Verificar valores NULOS ou Duplicados na Chave Primária
...
-- Padronização & Consistência dos Dados
SELECT DISTINCT 
    cst_marital_status 
FROM silver.crm_cust_info;
...
-- ====================================================================
-- Identificar Datas Fora do Intervalo Valido
